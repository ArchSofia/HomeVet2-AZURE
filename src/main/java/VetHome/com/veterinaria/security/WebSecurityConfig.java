package VetHome.com.veterinaria.security;
...
public class WebSecurityConfig {
    ...
    SecurityFilterChain filterChain(HttpSecurity http, @Autowired AuthenticationManager authManager) throws Exception {
        ...
        return http
                ...
                .requestMatchers(new AntPathRequestMatcher("/appointment/create")).authenticated() // Requiere autenticación solo para las solicitudes a '/reservas'
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("*", "http://127.0.0.1:3000", "https://purple-stone-0d3b70510.4.azurestaticapps.net"));
